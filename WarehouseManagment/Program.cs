...
//builder.Configuration.GetSection("ReCaptchaSettings_ASP_HostingBg").Bind(recaptchaSettings);
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy(ApplicationPolicies.RequireProductionWorker, policy =>
        policy.RequireRole(
...
builder.Services.AddScoped<IElectronicLabelService, NullElectronicLabelService>();
builder.Services.AddScoped<IFactoryService, FactoryService>();
builder.Services.AddScoped<ISaleService, SaleService>();
builder.Services.AddScoped<ICourierService, CourierService>();
builder.Services.AddScoped<IPosService, PosService>();
builder.Services.AddScoped<IFiscalDeviceService, NullFiscalDeviceService>();
builder.Services.AddScoped<IAccountingExportService, NullAccountingExportService>();
...
builder.Services.AddScoped<IFinishedGoodsStockQueryService, FinishedGoodsStockQueryService>();
